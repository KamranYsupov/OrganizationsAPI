...
Revision ID: 3bd126d77086
Revises: 
Create Date: 2025-10-19 18:19:25.597429
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_organization_activity'))
    )
    op.create_index(op.f('ix_organization_activity_id'), 'organization_activity', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_organization_activity_id'), table_name='organization_activity')
